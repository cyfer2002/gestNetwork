...
var checkPortsReseauxForm = eval(babel.transformFileSync(path.join(__dirname, '../../frontend/app/portsReseaux/check_form.es6'), {
  presets: ['env']
}).code);


router.post('/', function(req, res, next) {
  var errors = checkPortsReseauxForm(req.body);
